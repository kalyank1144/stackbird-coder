# Project management of stackbird.new
...
You can find the [epics as issues](https://github.com/stackblitz-labs/stackbird.new/labels/epic) which are probably never
going to be closed.
