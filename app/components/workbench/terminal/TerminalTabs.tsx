...
export const TerminalTabs = memo(() => {
  ...
  const closeTerminal = useCallback(
    (index: number) => {
      if (index === 0) {
        return;
      } // Can't close stackbird terminal
  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-stackbird-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-stackbird-elements-background-depth-2 border-y border-stackbird-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-stackbird-elements-terminals-buttonBackground text-stackbird-elements-textSecondary hover:text-stackbird-elements-textPrimary':
                            isActive,
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-stackbird-elements-textTertiary hover:text-stackbird-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachStackbirdTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting stackbird terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachStackbirdTerminal(terminal)}
