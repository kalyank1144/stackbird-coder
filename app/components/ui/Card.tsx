  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-stackbird-elements-borderColor bg-stackbird-elements-background-depth-1 text-stackbird-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-stackbird-elements-textSecondary', className)} {...props} />;
  },
);
