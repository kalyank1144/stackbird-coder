  ...
  return (
    <div
      className={classNames(
        ...
        'text-stackbird-elements-textSecondary dark:text-stackbird-elements-textSecondary-dark',
        'bg-stackbird-elements-background-depth-2 dark:bg-stackbird-elements-background-depth-3 rounded-lg',
        styles.container,
        className,
      )}
    >
      ...
      <div
        className={classNames(
          'rounded-full bg-stackbird-elements-background-depth-3 dark:bg-stackbird-elements-background-depth-4 flex items-center justify-center',
      ...
      {description && (
        <p
          className={classNames(
            'text-stackbird-elements-textTertiary dark:text-stackbird-elements-textTertiary-dark text-center max-w-xs',
            styles.description,
          )}
        >
          {description}
