      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-stackbird-elements-textPrimary dark:text-stackbird-elements-textPrimary-dark'
              : 'text-stackbird-elements-textSecondary dark:text-stackbird-elements-textSecondary-dark hover:text-stackbird-elements-textPrimary dark:hover:text-stackbird-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-stackbird-elements-textTertiary dark:text-stackbird-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
