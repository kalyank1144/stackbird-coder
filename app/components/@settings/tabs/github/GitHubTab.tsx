    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-stackbird-elements-textPrimary">GitHub Integration</h2>
        </div>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {connection?.rateLimit && (
              <div className="flex items-center gap-2 px-3 py-1 bg-stackbird-elements-background-depth-1 rounded-lg text-xs">
                <div className="i-ph:cloud w-4 h-4 text-stackbird-elements-textSecondary" />
                <span className="text-stackbird-elements-textSecondary">
        ...
        {stats?.repos && stats.repos.length > 0 && (
          <motion.div
            ...
            className="border-t border-stackbird-elements-borderColor pt-6"
          >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-stackbird-elements-background dark:bg-stackbird-elements-background-depth-2 border border-stackbird-elements-borderColor dark:border-stackbird-elements-borderColor hover:border-stackbird-elements-borderColorActive/70 dark:hover:border-stackbird-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-stackbird-elements-textSecondary',
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-stackbird-elements-borderColor">
