      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-stackbird-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-stackbird-elements-item-backgroundAccent hover:bg-stackbird-elements-artifacts-backgroundHover"
