...
<artifact_info>
  ...
  - Use \`<stackbirdArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<stackbirdAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<stackbirdArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<stackbirdAction>\` tags with appropriate \`type\` attribute:
