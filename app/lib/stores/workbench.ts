...
export class WorkbenchStore {
  ...
  get stackbirdTerminal() {
    return this.#terminalStore.stackbirdTerminal;
  }
  get alert() {
  ...
  attachStackbirdTerminal(terminal: ITerminal) {
    this.#terminalStore.attachStackbirdTerminal(terminal);
  }
