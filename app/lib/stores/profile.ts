...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('stackbird_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('stackbird_profile', JSON.stringify(profileStore.get()));
  }
};
