...
describe('StreamingMessageParser', () => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <stackbird', 'Foo bar '],
      ['Foo bar <stackbirda', 'Foo bar <stackbirda'],
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <stackbirdArtifact title="Some title" id="artifact_1">foo bar</stackbirdArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <stackbirdArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</stackbirdArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</stackbirdArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</stackbirdArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/stackbirdArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <stackbirdArtifact title="Some title" id="artifact_1">foo</stackbirdArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <stackbirdArtifact title="Some title" id="artifact_1"><stackbirdAction type="shell">npm install</stackbirdAction></stackbirdArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <stackbirdArtifact title="Some title" id="artifact_1"><stackbirdAction type="shell">npm install</stackbirdAction><stackbirdAction type="file" filePath="index.js">some content</stackbirdAction></stackbirdArtifact> After',
        {
          output: 'Before  After',
